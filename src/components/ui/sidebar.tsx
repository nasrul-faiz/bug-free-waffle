    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          overlayClassName="bg-black/10 dark:bg-black/20 backdrop-blur-sm"
          className="sidebar-mobile-surface text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden rounded-[18px] overflow-hidden border border-sidebar-border/60 h-auto shadow-[0_8px_32px_rgba(0,0,0,0.32),0_2px_8px_rgba(0,0,0,0.14)]"
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "flex h-full w-full flex-col overflow-hidden rounded-[18px] border border-sidebar-border/60",
            variant === "floating"
              ? "bg-sidebar shadow-sm"
              : "bg-[hsl(var(--sidebar)/1)] dark:bg-[hsl(var(--sidebar)/0.88)] group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm",
            innerClassName
          )}
          style={innerStyle}
        >
